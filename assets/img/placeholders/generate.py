...
{body}
<text x="{0.05*w:.0f}" y="{h-0.05*h:.0f}" font-family="system-ui, sans-serif" font-size="{max(14, round(min(w,h)*0.032))}" fill="{SAND}" fill-opacity=".82">Photograph to come · {label}</text>
</svg>
'''
